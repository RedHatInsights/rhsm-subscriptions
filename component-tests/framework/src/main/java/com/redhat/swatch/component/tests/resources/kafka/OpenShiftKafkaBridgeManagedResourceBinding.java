...
public class OpenShiftKafkaBridgeManagedResourceBinding
    implements KafkaBridgeManagedResourceBinding {
  @Override
  ...
  @Override
  public ManagedResource init(ComponentTestContext context, Service service, KafkaBridge metadata) {
