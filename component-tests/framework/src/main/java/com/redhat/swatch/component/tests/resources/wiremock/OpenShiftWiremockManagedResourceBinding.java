...
public class OpenShiftWiremockManagedResourceBinding implements WiremockManagedResourceBinding {
  @Override
  ...
  @Override
  public ManagedResource init(ComponentTestContext context, Service service, Wiremock metadata) {
