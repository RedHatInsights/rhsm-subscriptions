...
public final class SpringBootServiceConfigurationBuilder
    extends BaseConfigurationBuilder<
        com.redhat.swatch.component.tests.api.configuration.SpringBootServiceConfiguration,
        SpringBootServiceConfiguration> {

  private static final String EXPECTED_OUTPUT = "springboot.expected-log";

  @Override
  public SpringBootServiceConfiguration build() {
    SpringBootServiceConfiguration config = new SpringBootServiceConfiguration();
  ...
  protected Optional<
    ...
    return context.getAnnotatedConfiguration(
        com.redhat.swatch.component.tests.api.configuration.SpringBootServiceConfiguration.class,
