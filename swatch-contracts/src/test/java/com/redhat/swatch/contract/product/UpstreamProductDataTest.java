...
import com.redhat.swatch.contract.product.umb.ChildProduct;
import com.redhat.swatch.contract.product.umb.ProductAttribute;
import com.redhat.swatch.contract.product.umb.ProductRelationship;
...
class UpstreamProductDataTest {
  ...
  void testOfferingFromUpstreamForOcpOffering() {
    ...
    var sku = "MW01485";
    var expected = new OfferingEntity();
    expected.setSku(sku);
