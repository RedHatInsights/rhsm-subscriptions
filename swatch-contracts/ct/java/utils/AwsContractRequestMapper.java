...
/** Mapper for building AWS-specific ContractRequest objects. */
public class AwsContractRequestMapper extends ContractRequestMapper {
  ...
  protected PurchaseV1 buildPurchase(Contract contract) {
    return new PurchaseV1()
        ...
        .contracts(List.of(buildSaasContract(contract)));
  }
}
