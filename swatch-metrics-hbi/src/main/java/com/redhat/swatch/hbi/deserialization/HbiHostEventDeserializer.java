...
/**
 * Kafka deserializer for {@link HbiEvent}.
 *
 * <p>This class is registered by Quarkus automatically if specified in `application.properties` and
 * ensures that Jackson is used to deserialize HBI events from Kafka.
 */
