...
class MeasurementNormalizerTest {
  ...
  void setup() {
    ...
    applicationProperties.setUseCpuSystemFactsForAllProducts(false);
    measurementNormalizer = new MeasurementNormalizer(applicationProperties);
  }
  ...
  void testApplyVirtualCpusAsCoresLikeOcpForAllGuestsWhenEnabled() {
    ...
    applicationProperties.setUseCpuSystemFactsForAllProducts(true);
