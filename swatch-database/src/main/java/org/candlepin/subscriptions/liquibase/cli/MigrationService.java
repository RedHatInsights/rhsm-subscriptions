...
public class MigrationService {
  ...
  public static void main(String[] invocationArgs) {
    ...
    // swatch-contracts now handles its own migrations independently via Quarkus Liquibase extension
    // Only core migrations are managed by this service
    if (userContext == Context.ALL) {
      migrationContexts = new Context[] {Context.CORE};
    } else {
