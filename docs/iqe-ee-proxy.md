...
1. Create an iqe_workspace directory  
2. Copy get-iqe.py to directory:  
https://insights-qe.pages.redhat.com/iqe-core-docs/tutorial/part3.html#download-get-iqe-py
3. Run the script  
`python ./get-iqe.py`
4. Create a file in the iqe_workspace directory named iqe_env:  
...
`pip install -e [/iqe-core]`  
`pip install -e [/iqe-rhsm-subscriptions-plugin]`
