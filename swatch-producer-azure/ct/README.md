...
```bash
./mvnw clean install -Pcomponent-tests -pl swatch-producer-azure/ct -am
```
...
```bash
./mvnw clean install -Pcomponent-tests -pl swatch-producer-azure/ct -am -Dswatch.component-tests.global.target=openshift
```
