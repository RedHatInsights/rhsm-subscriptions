# Guide for "swatch-producer-azure" Component Tests
...
```bash
bonfire deploy rhsm --source=appsre --ref-env insights-stage --component swatch-kafka-bridge --component wiremock --component artemis --component swatch-producer-azure --no-remove-resources app:rhsm
```
