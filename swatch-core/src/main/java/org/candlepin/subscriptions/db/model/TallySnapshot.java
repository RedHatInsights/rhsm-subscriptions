...
public class TallySnapshot implements Serializable {
  ...
  // TODO(khowell): refactor this elsewhere
  ...
  //    }
  //
  //    HardwareMeasurement physical =
  // this.hardwareMeasurements.get(HardwareMeasurementType.PHYSICAL);
  //    if (physical != null) {
  ...
  //    }
  //
  //    HardwareMeasurement virtual =
  // this.hardwareMeasurements.get(HardwareMeasurementType.VIRTUAL);
  ...
  //    }
  //
  //    // Tally up all the cloud providers that we support. We count/store them separately in the
  // DB
  ...
  //        tallyMeasurements.get(new TallyMeasurementKey(HardwareMeasurementType.TOTAL,
  // Uom.CORES)));
  //
