...
/**
 * This class is the Spring Boot equivalent of ResteasyServletInitializer, which implements the
 * Servlet API {@link ServletContainerInitializer} interface to find all JAX-RS Application,
