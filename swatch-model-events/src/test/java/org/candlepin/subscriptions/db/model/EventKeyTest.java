...
class EventKeyTest {
  ...
  void testEquality() {
    OffsetDateTime now = OffsetDateTime.now();
    EventKey ek1 = new EventKey("org", "source", "instance", now);
    EventKey ek2 = new EventKey("org", "source", "instance", now);
    EventKey ek3 = new EventKey("org3", "source3", "instance3", now.minusDays(1));
  ...
  private EventKey keyForInstanceId(String instanceId, OffsetDateTime timestamp) {
    return new EventKey("org", "source", instanceId, timestamp);
  }
