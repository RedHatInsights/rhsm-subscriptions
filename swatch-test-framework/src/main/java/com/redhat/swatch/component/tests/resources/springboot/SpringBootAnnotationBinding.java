...
public class SpringBootAnnotationBinding implements AnnotationBinding {

  @Override
  public boolean isFor(Annotation... annotations) {
    return findAnnotation(annotations, SpringBoot.class).isPresent();
  }

  @Override
  public ServiceLifecycle getLifecycle(Annotation annotation) {
    return ((SpringBoot) annotation).lifecycle();
  }

  @Override
  public ManagedResource getManagedResource(
      ComponentTestContext context, Service service, Annotation... annotations) {
    SpringBoot metadata = findAnnotation(annotations, SpringBoot.class).get();
    ...
    return new LocalSpringBootManagedResource(metadata.service());
  }
}
