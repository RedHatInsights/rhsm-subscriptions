...
import static api.AwsWiremockService.CUSTOMER_AWS_ACCOUNT_ID_FIELD;
import static api.AwsWiremockService.CUSTOMER_IDENTIFIER_FIELD;
...
public class CustomerAwsAccountIdComponentTest extends BaseAwsComponentTest {
  ...
  void testUsesCustomerIdentifierWhenFlagOff() {
    ...
    wiremock.verifyBatchMeterUsageCustomerField(CUSTOMER_IDENTIFIER_FIELD, customerId);
  }
  ...
  void testUsesCustomerAwsAccountIdWhenFlagOn() {
    ...
    wiremock.verifyBatchMeterUsageCustomerField(
        CUSTOMER_AWS_ACCOUNT_ID_FIELD, CUSTOMER_AWS_ACCOUNT_ID);
  }
