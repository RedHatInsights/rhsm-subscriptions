...
class EventControllerIT implements ExtendWithSwatchDatabase {
  ...
  void testTransactionIsolationForFailedEvents() {
    ...
    // Verify that only the valid event was saved
  ...
  private List<String> createEventsWithInvalidSqlConstraints() {
    ...
    // Event 2: Invalid event with null measurement value (violates DB constraints)
    events.add(
        """
        {
           "sla": "Premium",
           ...
           "display_name": "another_test_server",
           "event_source": "prometheus",
           "measurements": [
             {
               "metric_id": "cores",
  ...
  private List<String> createIntraBatchConflictEvents() {
    ...
    // Event 2: cores = 2.0 (conflicts with Event 1)
    events.add(
        """
        {
           "sla": "Premium",
    ...
    // Event 3: cores = 3.0 (conflicts with Events 1 and 2)
    events.add(
        """
        {
           "sla": "Premium",
