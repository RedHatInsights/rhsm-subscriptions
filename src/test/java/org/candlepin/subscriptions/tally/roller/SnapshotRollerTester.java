...
public class SnapshotRollerTester<R extends BaseSnapshotRoller> {
  ...
  public void performUpdateWithLesserValueTest(
    ...
    AccountUsageCalculation a1HighCalc =
        createAccountCalc(account, "O1", TEST_PRODUCT, highCores, highSockets, highInstances);
    AccountUsageCalculation a1LowCalc =
        createAccountCalc(account, "O1", TEST_PRODUCT, lowCores, lowSockets, lowInstances);
  ...
  public void performDoesNotPersistEmptySnapshots(
    ...
    AccountUsageCalculation calc = createAccountCalc("12345678", "O1", TEST_PRODUCT, 0, 0, 0);
