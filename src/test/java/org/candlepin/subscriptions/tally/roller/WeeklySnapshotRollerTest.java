...
public class WeeklySnapshotRollerTest {
    ...
    public void testWeeklySnapshotProduction() {
        ...
        assertSnapshot(weeklySnaps.get(0), TEST_PRODUCT, Granularity.WEEKLY, a1ProductCalc.getTotalCores(),
    ...
    public void testWeeklySnapIsUpdatedWhenItAlreadyExists() {
        ...
        assertSnapshot(updated, TEST_PRODUCT, Granularity.WEEKLY, a1ProductCalc.getTotalCores(),
            a1ProductCalc.getTotalSockets(), a1ProductCalc.getTotalInstanceCount());
        assertSnapshotPhysicalTotals(updated, TEST_PRODUCT, Granularity.WEEKLY,
