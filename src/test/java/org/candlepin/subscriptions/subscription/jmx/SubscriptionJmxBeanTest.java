...
class SubscriptionJmxBeanTest {
    ...
    @Test
    void syncAllSubscriptionsTest() throws SubscriptionJmxException {
    ...
    @Test
    void syncSubscriptionForOrgTest() throws SubscriptionJmxException {
        subject.syncSubscriptionForOrg("123");
        Mockito.verify(subscriptionSyncController).syncAllSubcriptionsForOrg("123");
    }

    @Test
    void syncSubscriptionTest() throws SubscriptionJmxException, ApiException {
