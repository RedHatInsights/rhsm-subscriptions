-- Based on the original Quartz Postgresql schema, but with "IF NOT EXISTS" inserted for the create table
-- and create index statements so that we can have pods attempt to provision the schema when they come up
