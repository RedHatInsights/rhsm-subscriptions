--
-- Modified from the original schema to change all instances of the BINARY type to BLOB.  Based on the
-- answer to https://stackoverflow.com/questions/34784328/quartz-jobpersistenceexception-with-hsqldb
--
