...
import org.candlepin.subscriptions.metering.job.PartnersMeteringJob;
...
/** Defines the beans for the partners-metering-job profile. */
@Configuration
@Profile("partners-metering-job")
@Import({
        PrometheusServiceConfiguration.class,
        MeteringTasksConfiguration.class,
        TaskProducerConfiguration.class
})
public class PartnersMeteringJobProfile {
    ...
    @Bean
    PartnersMeteringJob partnersMeteringJob(
            PrometheusMetricsTaskManager tasks,
            ApplicationClock clock,
            PrometheusMetricsProperties metricProperties,
            ApplicationProperties appProps) {
        return new PartnersMeteringJob(tasks, clock, metricProperties, appProps);
    }

    @Bean
    JobRunner jobRunner(PartnersMeteringJob job, ApplicationContext applicationContext) {
