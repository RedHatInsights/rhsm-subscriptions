...
/**
 * A class to hold the rhsm-subscriptions data source configuration.
 */
@Configuration
...
public class DatabaseOrgListConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean rhsmSubscriptionsEntityManagerFactory(
        ...
        return builder
                   ...
                   .packages("org.candlepin.subscriptions.orgsync.db.model")
