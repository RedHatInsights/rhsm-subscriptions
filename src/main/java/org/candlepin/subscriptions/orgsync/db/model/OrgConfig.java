 ...
 */
package org.candlepin.subscriptions.orgsync.db.model;

import org.candlepin.subscriptions.orgsync.db.OptInType;
...
public class OrgConfig extends BaseConfig {
    ...
    public String toString() {
        return "OrgConfig{" + "orgId='" + orgId + '\'' + ", syncEnabled=" + syncEnabled + ", optInType=" +
            optInType + ", created=" + created + ", updated=" + updated + '}';
    }
