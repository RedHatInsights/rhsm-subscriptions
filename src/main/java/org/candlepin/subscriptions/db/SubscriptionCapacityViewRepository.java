...
public interface SubscriptionCapacityViewRepository
  ...
  List<SubscriptionCapacityView> findByKeyOwnerIdAndKeyProductIdAndServiceLevelAndUsage(
      String ownerId, String productId, ServiceLevel serviceLevel, Usage usage);
}
