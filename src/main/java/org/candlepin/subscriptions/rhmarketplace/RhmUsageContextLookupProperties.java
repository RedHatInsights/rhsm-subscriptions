...
@Component
@ConfigurationProperties(prefix = "rhsm-subscriptions.rh-marketplace.usage-context-lookup")
@Data
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class RhmUsageContextLookupProperties extends HttpClientProperties {
