...
import org.candlepin.subscriptions.tally.admin.api.SwatchTallyApi;
import org.candlepin.subscriptions.tally.admin.api.model.BillingAccountId;
import org.candlepin.subscriptions.tally.admin.api.model.BillingAccountIdResponse;
import org.springframework.stereotype.Component;

/** This resource is for exposing REST endpoints for Billing Account Ids. */
@Component
@Slf4j
public class BillingAccountIdResource implements SwatchTallyApi {
  ...
  public BillingAccountIdResponse fetchBillingAccountIdsForOrg(
    ...
    List<BillingAccountId> billingAccountIds = new ArrayList<>();
