...
/**
 * This is a Spring version of {@link ResteasyServletInitializer}. It does not register the servlets
 * though, that is done by {@link ResteasyApplicationBuilder} It only finds the JAX-RS Application
 * classes (by scanning the classpath), and the JAX-RS Path and Provider annotated Spring beans, and
 * then register the Spring bean definitions that represent each servlet registration.
 *
